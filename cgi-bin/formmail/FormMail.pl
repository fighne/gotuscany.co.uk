...
# $Id: FormMail.pl 285 2011-02-22 12:52:31Z CallumCampbell $
...
BEGIN
{
  ...
  $postmaster        = 'postmaster@gotuscany.co.uk';
  @referers          = qw(gotuscany.co.uk www.gotuscany.co.uk);
  @allow_mail_to     = qw(postmaster@gotuscany.co.uk);
  @recipients        = ();
  %recipient_alias   = ();
